...
class VipReportService {
    ...
    //Get Vip purchases for excel report 
    public async getVipPurchases(): Promise<any> {
        ...
        `;
        const vipPurchases = await dal.execute(sql);
...
export const vipReportService = new VipReportService();