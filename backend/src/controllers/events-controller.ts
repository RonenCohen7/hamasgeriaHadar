...
class EventController {
    ...
    public constructor() {
        ...
        this.router.get("/api/events/upcoming", this.getUpcomingEvents);
    ...
    //Get Event Upcoming
    private async getUpcomingEvents(request: Request, response: Response, next: NextFunction): Promise<void> {
        try {
